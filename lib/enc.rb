...
# Last Change: Fri Jul  1 22:49:38 2005
...
class ENC
  # encvector is an array of 256 strings, representing the position of
  # each glyph in the encoding. Example:
  # [".notdef", "dotaccent", "fi", "fl",  ...... , "yacute", "thorn",
  # "ydieresis"] 
  attr_accessor :encvector
